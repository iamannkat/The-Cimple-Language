    ...
    while state != 'eof' and state != 'OK' and state != 'error':
        ...
        if state == 'start':
            ...
            if token_char == '=':
                ...
                print('Incorrect assignment symbol. Expected =  after : ,at line: ' + str(file_line))
                sys.exit()
...
def program():
    ...
    if token == 'program':
        ...
        print('Please begin your program with the keyword < program >.\n')
        sys.exit()
...
def declarations():
    ...
    while token == 'declare':
        ...
        if token == ';':
            ...
            print('Expected ; at the end line: ' + str(file_line - comment_counter) + '.\n')
            sys.exit()
        else:
            print('Expected ; at the end line: ' + str(file_line-1) + '.\n')
            sys.exit()
    ...
    if token == 'id':
        ...
        while token == ',':
            ...
            if token == 'id':
                ...
                print('else; ' +token)
                print('Expected id at line' + str(file_line-1) + '.\n')
                sys.exit()
...
def subprogram():
    ...
    if token == 'function':
        ...
        if token == 'id':
            ...
            print('Please give a correct id at line' + str(file_line-1) + '.\n')
            sys.exit()
        ...
        if token == 'id':
            ...
            print('Please give a correct procedure name at line' + str(file_line-1) + '.\n')
            sys.exit()
    else:
        print('Please call a fuction or a procedure at line' + str(file_line-1) + '.\n')
        sys.exit()
...
def factor():
    ...
    if token.isdigit():
        ...
        print('Expected (, or id, or integer at line: ' + str(file_line-1) + '.\n')
        sys.exit()
...
def rel_op():
    ...
    if token == '=' or token == '<=' or token == '>=' or token == '>' or token == '<' or token == '<>':
        ...
        print('Expected a real optional character from (<,>,>=, <=, <>) at line: ' + str(file_line-1) + '.\n')
        sys.exit()
...
# fp = open('countDigits.txt', 'r')
# fp = open('fibonacci.txt', 'r')
# fp = open('factorial.txt', 'r')
# fp = open('compareDigits.txt', 'r')
